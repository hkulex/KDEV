...
{
    public class ScriptCustomizerWindow : EditorWindow
    {
        private const string WINDOW_NAME = "Script Customizer";
        ...
        [MenuItem("Tools/Script Customizer")]
        public static void Open()
        {
            ScriptCustomizerWindow window = GetWindow<ScriptCustomizerWindow>();
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("The Script Customizer allows you to create new templates \r\nfor C# scripts.", EditorStyles.boldLabel, GUILayout.Height(30));
